...
POINTING_t vincenty(int gs){
   ...
   if (gs == 1)
     { 
       ...
       phi2 =   34.504925 * (2*PI/360.);	/* Latitude */
       L2   = -104.219203 * (2*PI/360.);	/* Longitude */
       h2   = 1253.;				/* Altitude */
       //for testing
   ...
   if (gs == 2)
     { 
       /* Ground Station 2 is Lalo's Food, Vaughn, NM */
       phi2 =   34.594747 * (2*PI/360.);	/* Latitude */
       L2   = -105.188233 * (2*PI/360.);	/* Longitude */
       h2   = 1825.;				/* Altitude */
       //for testing
   ...
   if (gs == 3)
     {
       /* Ground Station 2 Alt A is Lalo's Food, Vaughn, NM */
       phi2 =   34.594747 * (2*PI/360.);	/* Latitude */
       L2   = -105.188233 * (2*PI/360.);	/* Longitude */
       h2   = 1825.;				/* Altitude */
    }
   ...
   if (gs == 4)
     {
       /* Ground Station 2 Alt B is Lalo's Food, Vaughn, NM */
       phi2 =   34.594747 * (2*PI/360.);	/* Latitude */
       L2   = -105.188233 * (2*PI/360.);	/* Longitude */
       h2   = 1825.;				/* Altitude */
    }
